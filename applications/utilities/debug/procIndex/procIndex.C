...
Description
    For a parallel run, writes processor index as a volScalarField for
    visualization purposes. For a serial run, exits with an error.
