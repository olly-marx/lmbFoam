...
plt.plot(data[:,0], np.sqrt(data[:,3]), label=r'$\langle u \rangle$')

# Add a legend
# plt.legend(fontsize=12, loc='upper right')
# Add axis labels
plt.xlabel(r'$t$ (s)')
plt.ylabel(r'$\langle u \rangle$ (m/s)')
...
# Save the figure
plt.savefig('/home/ojm40/foam/ojm40-5.0/work/liquidMetalBattery/run/postprocessing/u_rms_elec_vs_t'+saveName+'.pdf',\
